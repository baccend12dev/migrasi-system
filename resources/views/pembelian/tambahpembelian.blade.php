            ...
            <div class="row" id="form-input">
                <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="NO_LPB"
                                placeholder="Enter Nomor LPB">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate_lpb" data-target-input="nearest">
                                ...
                                <div class="input-group-append" data-target="#reservationdate_lpb"
